...
function(install_prg_dylibs)
	install(FILES
		"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libbase.dylib"
		"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libcrnss.dylib"
		"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libicuuc.dylib"
		"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libcrcrypto.dylib"
		"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libcrssl.dylib"
		"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libcrnspr.dylib"
		"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libicui18n.dylib"
		"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libnet.dylib"
		DESTINATION "${OBS_EXECUTABLE_DESTINATION}")
		
	add_custom_command(TARGET tblive POST_BUILD
		COMMAND "${CMAKE_COMMAND}" -E copy
			"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libbase.dylib"
			"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libcrnss.dylib"
			"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libicuuc.dylib"
			...
			"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libicui18n.dylib"
			"${CMAKE_SOURCE_DIR}/deps/peregrine/Mac64/bin/${CMAKE_BUILD_TYPE}/libnet.dylib"
			"${OBS_OUTPUT_DIR}/${CMAKE_BUILD_TYPE}/bin"
		VERBATIM)

	message(STATUS "Copy to: ${OBS_OUTPUT_DIR}/${CMAKE_BUILD_TYPE}/bin")
endfunction()
