...
#ifndef NET_BASE_RSA_BIGINT_H_
#define NET_BASE_RSA_BIGINT_H_
...
class NET_EXPORT BigInt
{
	...
	public:
		...
		std::string ToHexString(bool forceSign) const;
...
static BigInt& BigIntZero = *new BigInt();
  
// A BigInt number with the value of 1. 
static const BigInt& BigIntOne = *new BigInt(1L);

}// namespace net {
//#pragma GCC visibility pop

#endif /*NET_BASE_RSA_BIGINT_H_*/
