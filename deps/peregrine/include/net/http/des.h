...
enum KP_CCPADDING {
    KP_CCPADDING_NO_PADDING,
    KP_CCPADDING_PKCS_PADDING
};

NET_EXPORT_PRIVATE bool DesEncrypt( std::string const& key, std::string const& data, const uint8 *iv, KP_CCMODE mode, KP_CCPADDING padding, std::string & result );

NET_EXPORT_PRIVATE bool DesDecrypt( std::string const& key, std::string const& data, const uint8 *iv, KP_CCMODE mode, KP_CCPADDING padding, std::string & result );
