...
class BASE_EXPORT FilePath {
 public:
  ...
  FilePath Append(const std::string& component) const WARN_UNUSED_RESULT;
  FilePath Append(const std::wstring& component) const WARN_UNUSED_RESULT;
...
BASE_EXPORT FilePath::StringType ToPathString(std::string str);
BASE_EXPORT FilePath::StringType ToPathString(std::wstring str);
