...
class BASE_EXPORT Value {
 public:
  ...
  static FundamentalValue* CreateIntegerValue(int64 in_value);
  ...
  virtual bool GetAsInteger(int64* out_value) const;
...
class BASE_EXPORT FundamentalValue : public Value {
 public:
  ...
  virtual bool GetAsInteger(int64* out_value) const OVERRIDE;
...
class BASE_EXPORT DictionaryValue : public Value {
 public:
  ...
  bool GetInteger(const std::string& path, int64* out_value) const;
