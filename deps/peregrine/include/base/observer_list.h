...
// add shaokong. avoid application to process max/min macro with std max/min function compile conflict.
#undef _HAS_DEFINED_MIN_
#ifdef min
#define _HAS_DEFINED_MIN_
#undef min
#endif

#undef _HAS_DEFINED_MAX_
#ifdef max
#define _HAS_DEFINED_MAX_
#undef max
#endif
...
#ifdef _HAS_DEFINED_MIN_
#define min(a,b) ((a) > (b) ? (b) : (a))
#endif

#ifdef _HAS_DEFINED_MAX_
