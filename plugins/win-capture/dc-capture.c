...
void dc_capture_capture(struct dc_capture *capture, HWND window)
{
	...
	// TODO: CAPTUREBLT support "Layered Window" under xp, or win7 when AERO turn off
	// But it is just care the rect of window, not the content itself
	// May be need to use DWM, @see: https://msdn.microsoft.com/zh-cn/library/windows/desktop/aa969526(v=vs.85).aspx
